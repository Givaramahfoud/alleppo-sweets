            ...
            <div className='container'>
                <CardDeck className='cardDeck'>
                    <Card className={isOpen ? 'open' : 'cards'} >
                        ...
                        <CardBody>
                            <CardTitle className='titles'>حلو ناشف</CardTitle>
                        </CardBody>
                    ...
                    <Card className={isOpen2 ? 'open' : 'cards'}>
                        <CardImg src={Salad} alt="Card image cap" />
                        <CardBody>
                            <CardTitle className='titles'>راحة</CardTitle>
                        </CardBody>
                    ...
                    <Card className={isOpen3 ? 'open' : 'cards'}>
                        <CardImg src={Salad} alt="Card image cap" />
                        <CardBody>
                            <CardTitle className='titles'>حلو عربي</CardTitle>
                        </CardBody>
                    ...
                    <Card className={isOpen4 ? 'open' : 'cards'}>
                        <CardImg src={Salad} alt="Card image cap" />
                        <CardBody>
                            <CardTitle className='titles'>مكسرات</CardTitle>
                        </CardBody>
                    ...
                    <Card className={isOpen5 ? 'open' : 'cards'}>
                        <CardImg src={Salad} alt="Card image cap" />
                        <CardBody>
                            <CardTitle className='titles'>بذورات</CardTitle>
                        </CardBody>
...
.form {
    ...
    margin: 80px;
    padding: 40px;
    background - color: rgb(250, 213, 127);
    border - radius: 20px;
    text - align: center;
}
